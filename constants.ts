...
export const MOCK_CONTENT: ContentItem[] = [
  ...
  },
  {
    ...
    thumbnailUrl: '/Mayumi_2025.jpg',
    backdropUrl: '/Mayumi_2025.jpg',
    rating: 'TV-MA',
    duration: '1 Season',
    genre: ['Drama', 'Crime'],
    accessType: AccessType.PREMIUM,
  ...
  },
  {
    ...
    type: ContentType.SERIES,
    thumbnailUrl: '/Mark_2025.jpg',
    backdropUrl: '/Mark_2025.jpg',
    rating: 'TV-14',
    duration: '3 Seasons',
  ...
  },
  {
    ...
    description: 'The story is about the hero who comes to Chennai Central from a small village due to his family situation, what kind of hardships does he experience in the name of capitalism and how does he recover from it.',
    type: ContentType.MOVIE,
    thumbnailUrl: 'https://cinestreampremier.netlify.app/Ikkis_2026.jpg',
    backdropUrl: 'https://cinestreampremier.netlify.app/Ikkis_2026.jpg',
    rating: 'PG-13',
    duration: '1h 45m',
    genre: ['War'],
    accessType: AccessType.FREE,
